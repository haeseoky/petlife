...
const MBTI_DATA = {
  dog: {
    ...
    '정': { title: '섬세한 감성 예술가', emoji: '🕯️', desc: '따뜻한 등불처럼 섬세하고 깊은 내면을 가졌어요. 주인의 기분을 누구보다 빨리 알아채고 조용히 곁을 지켜주는 다정한 아이예요.', strengths: ['섬세한 관찰력', '깊은 유대감', '차분함'], growth: ['소심함 극복', '낯선 환경 적응'] },
    ...
    '기': { title: '포근한 대지의 품', emoji: '🌾', desc: '모든 것을 품어주는 넓고 비옥한 대지 같은 아이예요. 성실하고 온화하며 누구와도 다투지 않는 평화로운 성품을 지녔습니다.', strengths: ['포용력', '성실함', '조화로움'], growth: ['자기 의사 표현', '스트레스 해소'] },
