<template>
  <div class="game-page">
    <nav class="game-nav">
      ...
      <span class="game-title">🧩 짝 맞추기</span>
      <span></span>
    </nav>
    <MemoryGame @score="onScore" @share="onShare" />
    <ShareModal :visible="showShare" game-name="짝 맞추기" :score="lastScore" @close="showShare = false" />
  </div>
</template>
...
<style scoped>
.game-page { height: 100dvh; display: flex; flex-direction: column; }
